...
//            ((TextView) appCard.findViewById(R.id.app_title)).setText(getAppName());
        ...
        if (morpheCardContainer != null) {
            ...
            morpheCard.findViewById(R.id.morphe_github).setOnClickListener(v -> openUrl("https://github.com/Utsavrajputt/MicroG-24"));
            morpheCard.findViewById(R.id.morphe_x).setOnClickListener(v -> openUrl(""));
            morpheCard.findViewById(R.id.morphe_reddit).setOnClickListener(v -> openUrl(""));
            morpheCard.findViewById(R.id.morphe_website).setOnClickListener(v -> openUrl(""));
        }
